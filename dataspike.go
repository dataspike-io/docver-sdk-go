...
// WithEndpoint is a Option that allows you using customizable http.Client.
// When this option is nil, http.DefaultClient will using.
...
func NewDataspikeClient(options ...Option) IDataspikeClient {
