...
func Test_dataspikeClient_CancelVerification(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			dc := dataspike.NewDataspikeClient(dataspike.WithEndpoint(url), dataspike.WithToken(token))
...
func Test_dataspikeClient_CreateApplicant(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			dc := dataspike.NewDataspikeClient(dataspike.WithEndpoint(testServer.URL), dataspike.WithToken(token))
...
func Test_dataspikeClient_ListWebhooks(t *testing.T) {
	t.Parallel()
	tests := []struct {
		name    string
		handler http.HandlerFunc
...
func Test_dataspikeClient_DeleteWebhook(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			url := testServer.URL
			dc := dataspike.NewDataspikeClient(dataspike.WithEndpoint(url), dataspike.WithToken(token))
			err = dc.DeleteWebhook(webhookID)
